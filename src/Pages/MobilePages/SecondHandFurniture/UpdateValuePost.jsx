...
// @ts-ignore
function UpdateValuePost(props) {
  const { post } = props;

  return (
    <>
      <Card
        width={{ base: "90%", md: "90%" }} // Adjusting width for responsiveness
        display="flex"
        boxShadow="0 0 8px rgba(0, 0, 0, 0.2)"
      >
        <Box alignItems="center" justifyContent="center" mt={8} display="flex">
          <Box className={"left-right-anim"}>
        ...
        >
          <Box p={6} maxWidth={{ base: "100%", md: "90%" }}>
            <Heading
              as="h2"
              size={{ base: "sm", md: "md" }} // Adjusting font size for responsiveness
              color={"#006D6C"}
              fontWeight={"bold"}
              textAlign="center"
            >
...
export default UpdateValuePost;
